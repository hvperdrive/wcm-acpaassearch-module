...
const indexController = require("../controllers/reindexAll");
...
const PermissionsSecurity = require("@wcm/module-helper").permissionsSecurity("acpaassearch");
// Building the baseUrl based on the configuration. Every API call needs to be located after the api/ route
const baseUrl = "/" + config.api.prefix + config.api.version + "acpaassearch";
